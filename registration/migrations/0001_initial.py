    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relation_to_delegate', models.CharField(blank=True, max_length=100, null=True)),
                ('meal_preference', models.CharField(blank=True, max_length=50, null=True)),
                ('join_event', models.BooleanField(default=False)),
                ('lunch', models.CharField(default='none', max_length=20)),
                ...
                ('created_at', models.DateField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('registered_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='accompanying_persons', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
